...
const i18n = {
    ...
    translations: {
        zh: {
            ...
            'recharge.currencyPlaceholder': '请选择币种',
            'recharge.cryptoNetwork': '选择网络',
            'recharge.networkPlaceholder': '请选择网络',
            'recharge.serviceInfo': '服务信息',
            'recharge.serviceStatus': '服务状态',
            'recharge.serviceAvailable': '可用',
            'recharge.serviceUnavailable': '不可用',
            'recharge.serviceEmpty': '请选择币种和网络',
            'recharge.minAmount': '最低金额',
            'recharge.maxAmount': '最高金额',
            'recharge.feePercent': '手续费比例',
            'recharge.feeAmount': '手续费固定值',
            'recharge.confirmationsRequired': '确认数',
            'recharge.cryptoAmount': '支付币种金额',
            'recharge.paymentId': '支付单号',
            'recharge.paymentLink': '支付链接',
            'recharge.openPayLink': '<i class="fas fa-external-link-alt"></i> 打开',
            'recharge.networkLabel': '网络',
            'recharge.qrUnavailable': '地址生成后将显示二维码',
            'recharge.rates': '当前汇率',
            ...
            'recharge.toast.selectAmount': '请选择充值金额',
            'recharge.toast.selectCurrency': '请选择币种',
            'recharge.toast.selectNetwork': '请选择网络',
            'recharge.toast.serviceUnavailable': '当前网络不可用',
            'recharge.toast.minAmount': '最低金额为 {min} {currency}',
            'recharge.toast.maxAmount': '最高金额为 {max} {currency}',
            'recharge.toast.creating': '正在创建充值订单...',
            'recharge.toast.created': '订单创建成功，请扫码支付',
            'recharge.toast.failed': '充值失败',
            'recharge.toast.success': '充值成功！',
            'recharge.toast.expired': '支付已过期，请重新创建订单',
            'recharge.toast.cancelled': '支付已取消',
            'recharge.toast.copy': '地址已复制到剪贴板',
            'recharge.toast.copyAmount': '金额已复制到剪贴板',
            'recharge.toast.copyAmountEmpty': '暂无可复制的金额',
            'recharge.toast.copyLink': '支付链接已复制到剪贴板',
            'recharge.toast.copyLinkEmpty': '暂无可复制的支付链接',
            'recharge.toast.openLinkEmpty': '暂无可打开的支付链接',
            'recharge.status.paid': '支付成功',
            'recharge.status.paid_over': '支付成功（超额）',
            'recharge.status.wrong_amount': '支付金额不足',
            'recharge.status.process': '支付处理中',
            'recharge.status.confirm_check': '等待区块确认',
            'recharge.status.wrong_amount_waiting': '金额不足，等待补款',
            'recharge.status.check': '等待支付',
            'recharge.status.pending': '等待支付',
            'recharge.status.confirmed': '支付已确认',
            'recharge.status.fail': '支付失败',
            'recharge.status.cancel': '支付已取消',
            'recharge.status.system_fail': '系统错误',
            'recharge.status.refund_process': '退款处理中',
            'recharge.status.refund_fail': '退款失败',
            'recharge.status.refund_paid': '退款完成',
            'recharge.status.locked': '资金已锁定（AML）',
            'recharge.status.expired': '支付已过期',
            'recharge.status.wrong_currency': '币种不匹配',
        ...
        en: {
            ...
            'recharge.currencyPlaceholder': 'Select currency',
            'recharge.cryptoNetwork': 'Select Network',
            'recharge.networkPlaceholder': 'Select network',
            'recharge.serviceInfo': 'Service Info',
            'recharge.serviceStatus': 'Service Status',
            'recharge.serviceAvailable': 'Available',
            'recharge.serviceUnavailable': 'Unavailable',
            'recharge.serviceEmpty': 'Select currency and network',
            'recharge.minAmount': 'Minimum Amount',
            'recharge.maxAmount': 'Maximum Amount',
            'recharge.feePercent': 'Fee Percent',
            'recharge.feeAmount': 'Fee Amount',
            'recharge.confirmationsRequired': 'Confirmations',
            'recharge.cryptoAmount': 'Crypto Amount',
            'recharge.paymentId': 'Payment ID',
            'recharge.paymentLink': 'Payment Link',
            'recharge.openPayLink': '<i class="fas fa-external-link-alt"></i> Open',
            'recharge.networkLabel': 'Network',
            'recharge.qrUnavailable': 'QR code will appear after the address is ready',
            ...
            'recharge.toast.selectAmount': 'Select recharge amount',
            'recharge.toast.selectCurrency': 'Select currency',
            'recharge.toast.selectNetwork': 'Select network',
            'recharge.toast.serviceUnavailable': 'Selected network is unavailable',
            'recharge.toast.minAmount': 'Minimum amount is {min} {currency}',
            'recharge.toast.maxAmount': 'Maximum amount is {max} {currency}',
            'recharge.toast.creating': 'Creating recharge order...',
            'recharge.toast.created': 'Order created, please scan to pay',
            'recharge.toast.failed': 'Recharge failed',
            'recharge.toast.success': 'Recharge successful!',
            'recharge.toast.expired': 'Payment expired, please create a new order',
            'recharge.toast.cancelled': 'Payment cancelled',
            'recharge.toast.copy': 'Address copied to clipboard',
            'recharge.toast.copyAmount': 'Amount copied to clipboard',
            'recharge.toast.copyAmountEmpty': 'No amount to copy',
            'recharge.toast.copyLink': 'Payment link copied to clipboard',
            'recharge.toast.copyLinkEmpty': 'No payment link to copy',
            'recharge.toast.openLinkEmpty': 'No payment link to open',
            'recharge.status.paid': 'Payment successful',
            'recharge.status.paid_over': 'Payment successful (overpaid)',
            'recharge.status.wrong_amount': 'Amount paid is less than required',
            'recharge.status.process': 'Payment processing',
            'recharge.status.confirm_check': 'Waiting for confirmations',
            'recharge.status.wrong_amount_waiting': 'Underpaid, awaiting additional payment',
            'recharge.status.check': 'Payment pending',
            'recharge.status.pending': 'Payment pending',
            'recharge.status.confirmed': 'Payment confirmed',
            'recharge.status.fail': 'Payment failed',
            'recharge.status.cancel': 'Payment cancelled',
            'recharge.status.system_fail': 'System error',
            'recharge.status.refund_process': 'Refund processing',
            'recharge.status.refund_fail': 'Refund failed',
            'recharge.status.refund_paid': 'Refund completed',
            'recharge.status.locked': 'Funds locked (AML)',
            'recharge.status.expired': 'Payment expired',
            'recharge.status.wrong_currency': 'Wrong currency',
